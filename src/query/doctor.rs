...
pub(crate) struct WorkspaceTaskCounts {
    pub(crate) visible: i64,
    pub(crate) total: i64,
}

pub(crate) async fn workspace_task_counts(
...
pub(crate) async fn unresolved_conflict_count(conn: &mut SqliteConnection) -> Result<i64> {
    Ok(
