...
pub(crate) const BG_LANE: Color = Color::Rgb(24, 25, 24);
pub(crate) const BG_LANE_ACTIVE: Color = Color::Rgb(27, 26, 32);
pub(crate) const LANE_DIVIDER: Color = Color::Rgb(49, 50, 47);
...
pub(crate) const CUSTOM_COMMAND_NAME: Color = Color::Rgb(224, 151, 92);
pub(crate) const CUSTOM_COMMAND_TAG: Color = Color::Rgb(190, 126, 82);
