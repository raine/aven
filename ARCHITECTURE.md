...
7. `src/tui/ui.rs` and `src/tui/ui/` render state. Task detail Markdown image placeholders use attachment metadata from the selected task list item. Rendering code should not touch the database.
