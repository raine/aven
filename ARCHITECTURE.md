...
| Recurrence domain | validated series IDs, fixed calendar rules, Monday-anchored schedule expansion, series-zone slot timing, DST resolution, and deterministic occurrence identity | `crates/aven-core/src/recurrence.rs`, `crates/aven-core/src/recurrence/` | Schedule math and occurrence identity stay pure and device-independent. Persisted recurrence operations and read models belong to core rather than CLI or TUI adapters. |
...
| Add or change recurrence schedule math or deterministic occurrence identity | `crates/aven-core/src/recurrence/` | `crates/aven-core/src/recurrence.rs`, recurrence operations and sync validation when persisted behavior is involved | `cargo test -p aven-core recurrence` |
