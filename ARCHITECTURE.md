...
| Add or change TUI onboarding | `src/tui/app_onboarding.rs`, `src/tui/store/onboarding.rs` | `src/tui/mod.rs`, `src/tui/overlay/`, `src/tui/ui/overlays/onboarding.rs`, welcome command in `src/tui/event/catalog.rs` | focused app, store, overlay, and rendering tests |
